...
st.caption("VP-level trade setups — only high-confidence plays (≥75) are shown.")
st.markdown("---")
...
with st.expander("⚙️ Scan Controls", expanded=False):
    ...
    with col3:
        min_conf = st.slider("Min Confidence", min_value=75, max_value=95, value=75, step=5)
...
if not recommendations:
    st.info(
        "No high-confidence recommendations found with current filters. "
